...
const DailyOrderVolume = () => {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#e2e8f0] h-[450px] flex flex-col">
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            <Area
              ...
              activeDot={{ r: 6, fill: "#127690", stroke: "#fff", strokeWidth: 2 }}
              dot={{ r: 4, fill: "#127690", stroke: "transparent" }}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
